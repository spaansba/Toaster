...
const ConnectedToaster = () => {
  return (
    <View className="relative">
      <View
        className="absolute bg-black w-full h-[90px] rounded"
        style={{
          left: 5,
          top: 5,
        }}
      />
      <View className="relative w-full h-[90px] border-black border-2 bg-toaster-yellow z-20 rounded">
        <View className="flex-1 flex-row items-center mx-4">
          ...
          <View className="ml-3 gap-4 flex-1 justify-center">
